...
const SvgArrowSquareUpLeft = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <path d="m9.586 8.172 3.95 3.95a1 1 0 1 1-1.415 1.414l-3.95-3.95v3.586a1 1 0 0 1-2 0v-6a.997.997 0 0 1 1-1h6a1 1 0 1 1 0 2z" />
  </svg>
);
